...
public class View231ZawodnikDodajDoReprezentacjaWMundial extends JFrame implements ActionListener {
    ...
    public View231ZawodnikDodajDoReprezentacjaWMundial() {
    ...
    public static void main(String[] args) {
       new View231ZawodnikDodajDoReprezentacjaWMundial();
    }
}
